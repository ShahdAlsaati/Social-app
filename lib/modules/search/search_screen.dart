...
class searchScreen extends StatelessWidget {
                    ...
                    children: [
                      defaultFormField(
                          ...
                          onSubmit: (String text){
                            SearchCubit.get(context).search(text.toLowerCase());
                          }
                      ),
                      SizedBox(
                        height: 15,
  ...
  Widget buildUserItem(SearchModel model,context)=>InkWell(
    onTap:(){
      navigateTo(context,userDetailScreen(uId: model.uId,));
    },
    child: Padding(
      padding: const EdgeInsets.all(20.0),
      child: Row(
